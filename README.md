...
I'm **Alimuhammad Rajwani**, a dedicated **BSIT student** at **Sir Syed University of Engineering and Technology** with a passion for **cybersecurity**, **cloud computing**, and **software development**. My goal is to bridge the gap between innovation and practical solutions, contributing to the tech community while constantly expanding my knowledge.

- 🛡️ **Cybersecurity Enthusiast**: Exploring security vulnerabilities and risk mitigation.
- 🌐 **Full-Stack Development**: Skilled in both front-end and back-end technologies.
- 📚 **Eager Learner**: Expanding my skillset in **Python**, **C#**, and **React Native**.
