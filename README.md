...
I'm **Alimuhammad Rajwani**, a motivated **BSIT student** at **Sir Syed University of Engineering and Technology**, with a passion for **cybersecurity**, **cloud computing**, and **software development**. My goal is to blend creativity with real-world solutions while continuously learning and contributing to the tech ecosystem.

- 🛡️ **Cybersecurity Enthusiast**: Exploring vulnerabilities and risk management strategies.
- 🌐 **Full-Stack Developer**: Engaging in front-end and back-end projects.
- 📚 **Lifelong Learner**: Expanding my skills in **Python**, **C#**, and **React Native**.
...
<table align="center" width="100%">
  <tr>
    <td align="center" width="50%" style="padding: 15px;">
      ...
      <p>Simulates CPU scheduling algorithms used in operating systems.</p>
      <strong>Tech Stack:</strong> C#
    </td>
    <td align="center" width="50%" style="padding: 15px;">
      <a href="https://github.com/AliMuhammad-Rajwani/Window-System-Update.git">
      ...
      <p>Automates Windows system updates using PowerShell and Bash scripts.</p>
      <strong>Tech Stack:</strong> PowerShell, Bash
    </td>
  </tr>
  <tr>
    <td align="center" width="50%" style="padding: 15px;">
      ...
      <p>A system for managing orders and inventory for coffee shops.</p>
      <strong>Tech Stack:</strong> C#, SQL
    </td>
    <td align="center" width="50%" style="padding: 15px;">
      <a href="https://github.com/AliMuhammad-Rajwani/React-Native-App.git">
      ...
      <p>A mobile app for cross-platform development using React Native.</p>
      <strong>Tech Stack:</strong> React Native, JavaScript
    </td>
  </tr>
</table>
...
- 🔭 Expanding knowledge in **Python** for data science and automation.
- 🌱 Developing skills in **cloud technologies** like **Azure** and **AWS**.
- 💬 Open to discussions about **software development**, **algorithms**, and **cybersecurity**.
